// 第一页第三层：真三维核反应堆（开放式水池研究堆）。
//
// 为什么推翻旧做法：旧反应堆是 reactorShader.js 里在一整块平面上画出来的图案，
// 从任何角度看都是一张贴图——没有体积、没有遮挡、没有独立运动。这里改成一个个
// 真实的 Three.js 三维部件，各自有几何、材质、状态和更新逻辑，玻璃立方体从上方
// 俯视时会真实地折射、遮挡它们，改变视角/光照也能看出是立体结构。
//
...
//
// 公开资料来源（在 PROJECT.md 和实现报告里同样记录）：
