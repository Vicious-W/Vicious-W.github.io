...
当前实现尚未具备独立轻水动力学、SOURCE 连续运行控制器、玻璃耐久或真实碎片系统。
也尚未具备完整的反应堆池、生物屏蔽、桥架/格栅、环境设备、实验设施和三回路
冷却结构。这些系统的空间关系、会话重置和跨系统耦合定义在
`docs/engineering/SOURCE_SCENE.md`，完整反应堆池与连续运行定义在
